...
//    freopen("output.txt", "w", stdout);
    ...
    f(tc, 1, T){
        ...
        else if(x<0 && y>0 && l>=abs(x) && u>=abs(y)){
            YES;
        }
        else if(x<0 && y<0 && l>=abs(x) && d>=abs(y)){
            YES;
        }
        else if(x>0 && y<0 && r>=abs(x) && d>=abs(y)){
            YES;
        }
        else if(x==0 && y>0 && u>=y){
            YES;
        }
        else if(x==0 && y<0 && d>=abs(y)){
            YES;
        }
        else if(x<0 && y==0 && l>=abs(x)){
            YES;
        }
        else if(x>0 && y==0 && r>=abs(x)){
            YES;
        }
        else{
            NO;
